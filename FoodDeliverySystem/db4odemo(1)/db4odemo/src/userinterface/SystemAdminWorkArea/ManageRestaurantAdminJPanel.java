    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        String name = nameJTextField.getText();
         ...
         for (UserAccount acco : restaurant.getUserAccountDirectory().getUserAccountList()){
            ...
            {
                JOptionPane.showMessageDialog(null,"Morethan one Admin in one restaurant is not allowed"); 
               return;
            }
        ...
        UserAccount account = restaurant.getUserAccountDirectory().createUserAccount(username, password, employee, new AdminRole());
