...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
            ...
            for(Location network:system.getNetworkList()){
                ...
                for(Restaurant restaurant:network.getRestaurantDirectory().getRestaurantList()){
                    ...
                    if(userAccount==null){
                      ...
                      /* for(Organization organization:restaurant.getOrganizationDirectory().getOrganizationList()){
        ...
        if(userAccount==null){
         ...
         //  Role role = 
            container.add("workArea",userAccount.getRole().createWorkArea(container, userAccount,inOrganization, inRestaurant,  system));
