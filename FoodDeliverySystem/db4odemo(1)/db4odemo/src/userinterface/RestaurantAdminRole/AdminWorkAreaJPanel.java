...
public class AdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public AdminWorkAreaJPanel(JPanel userProcessContainer, Restaurant restaurant, EcoSystem ecosystem , UserAccount account) {
        initComponents();
    ...
    private void manageEmployeeJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeeJButtonActionPerformed
        ManageMenuJPanel manageMenuJPanel=new ManageMenuJPanel(userProcessContainer, restaurant, ecosystem,userAccount );
    ...
    private void manageOrganizationJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageOrganizationJButtonActionPerformed
        ManageOrdersJPanel manageOrderWorkAreaJPanel=new ManageOrdersJPanel(userProcessContainer, userAccount ,ecosystem,restaurant );
        userProcessContainer.add("manageOrderWorkAreaJPanel",manageOrderWorkAreaJPanel);
        CardLayout layout=(CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer); 
