...
import userinterface.RegHealthManagerRole.HealthInsuManagerWorkAreaJPane;
 ...
 * @author raunak
 */
public class RegHealthInsuranceManagerRole extends Role{
  ...
  /*  @Override
    ...
    @Override
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem business) {
      return new HealthInsuManagerWorkAreaJPane(userProcessContainer, account,(HealthInsuranceRegulatoryOrganization)organization ,business);
